...
1. **ให้ผู้เรียนถามคำถาม ก่อนตอบ**
   - "ใครคิดว่าจังหวัดไหนให้ผลผลิดดี?"
   - "ทำไมแปลงนี้ผลผลิตต่ำ?"

2. **สร้าง "Aha!" Moment**
   - ตัวอย่าง: "ปุ๋ยเกินกว่า 7 kg ก็เหมือนเทเงินลงหลุม!"

3. **Link ไปประสบการณ์ของเขา**
   - "ใครเก่งปลูกข้าว? เคย สัง เกตว่า ปีไหนฝนเยอะ ผลผลิดดี?"

4. **สรุปเป็น 1 Sentence**
   - "ข้อมูลที่ดี + Logic ที่สมเหตุ = AI ที่ช่วยเกษตร"

5. **ไม่ต้องสนใจตัวเลข ให้ดูแนวโน้ม**
   - ถ้า Rainfall 2,200+ มม. vs 1,800 มม. → ผลผลิดต่างกัน 100+ kg/ไร่
   - "ความแตกต่างนี้สำคัญไหม?" → "ใช่! 100 kg × 400 บาท = 40,000 บาท/ไร่"
